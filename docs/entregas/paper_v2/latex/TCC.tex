...
Este trabalho propõe a adaptação do \textit{Ralph Wiggum Loop}, paradigma de orquestração originalmente concebido para fluxos focados em desenvolvimento e engenharia de software e que traz soluções para mitigar problemas de \textit{context rot}, para um fluxo de resolução generalista, focado em responder perguntas em linguagem natural. A hipótese é que essa estrutura melhora a qualidade das respostas em relação à inferência singular, e essa hipótese é avaliada por meio dos \textit{datasets} MMLU e GPQA, comparando chamadas diretas ao modelo com execuções mediadas pelo \textit{harness} proposto, utilizando modelos da família Llama~3.1 com diferentes quantidades de parâmetros. A acurácia, medida pela correspondência entre a alternativa selecionada pelo sistema e o gabarito oficial, é adotada como métrica principal.}
